...
excerpt: 'A 3D Gaussian primitive-based self-supervised reconstruction framework for improving resolution and reconstruction quality in Fourier light-field microscopy.'
date: 2025-09-23
...
<p align="center">
  <img src="{{ "/files/3DGAT/pipeline.svg" | relative_url }}" alt="3DGAT overview">
</p>